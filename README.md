...
A secure password generator application with password strength checking and customizable password options.

### Task 4 - Weather App
A weather application that fetches real-time weather data using OpenWeatherMap API.
